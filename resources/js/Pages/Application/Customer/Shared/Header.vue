<template>
  ...
  >
    <div class="flex items-center">
      <button @click="openSidebar" class="focus:outline-none">
    ...
    <div class="flex items-center space-x-2 md:flex-nowrap text-sm font-medium">
      ...
      <div
        v-if="$page.props.user.is_employee || $page.props.user.is_customer"
      ...
      <div>
        <dropdown align="right" width="96">
          <template #trigger>
            <dropdown-link v-if="$page.props.jetstream.managesProfilePhotos">
              <img
          ...
          <template #content>
            <!-- Account Management -->
            <div class="block px-4 py-2 text-xs text-gray-400">Meine Daten</div>
